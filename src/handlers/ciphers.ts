...
import {
  ...
  normalizeCipherTimestamp,
  normalizeOptionalId,
  optionalEncString,
  readIncomingAttachmentMetadata,
  shouldPreserveRepairableCipherUris,
  validateCipherEncryptedFieldsForCompatibility,
} from '../services/cipher-domain';
import {
...
function normalizeCipherForStorage(cipher: Cipher): Cipher {
  ...
  const hasArchivedAt = Object.hasOwn(cipher as object, 'archivedAt');
